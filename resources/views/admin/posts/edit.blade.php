            ...
            <div class="card border-0 shadow-sm mb-3">
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        ...
                        @else
                        <input type="text" class="form-control bg-light" value="{{ ucfirst($post->status) }}" readonly>
                        <input type="hidden" name="status" value="{{ $post->status }}">
                        <small class="text-muted">You do not have permission to change publish status.</small>
                        @endif
                    </div>
